...
const STOP_WORDS = new Set([
  ...
  'would', 'could', 'may', 'might', 'can', 'need', 'must', 'ought',
  ...
  'up', 'down', 'in', 'on', 'at', 'to', 'of', 'by', 'as', 'if',
  'that', 'this', 'these', 'those', 'what', 'which', 'who', 'whom',
  'how', 'when', 'where', 'why', 'its', 'it', 'we', 'they', 'you',
  'he', 'she', 'our', 'your', 'their', 'his', 'her', 'my',
]);

const FILLER_WORDS = new Set([
  'experience', 'team', 'work', 'company', 'role', 'position', 'job',
  'ability', 'skills', 'requirements', 'qualifications', 'responsibilities',
  'opportunity', 'looking', 'seeking', 'join', 'ideal', 'candidate',
  'required', 'preferred', 'plus', 'strong', 'excellent', 'good',
  'working', 'environment', 'culture', 'benefits', 'salary', 'apply',
  'include', 'including', 'etc', 'well', 'like', 'new', 'use', 'using',
  'ensure', 'help', 'across', 'within', 'part', 'best', 'years',
]);
