...
const posts: BlogPost[] = [
  {
    ...
    description: 'Data shows tailored resumes get 3x more interviews. Here\'s the science behind keyword matching, ATS systems, and what recruiters actually look for.',
    date: '2026-03-16',
    readTime: '5 min',
  },
  {
    ...
    description: 'Most resumes are rejected by software before a human sees them. Learn how Applicant Tracking Systems work and how to beat them.',
    date: '2026-03-16',
    readTime: '4 min',
  },
  {
    ...
    description: 'Which keywords matter, which are filler, and how to find the right ones for any job description.',
    date: '2026-03-16',
    readTime: '6 min',
  },
];
