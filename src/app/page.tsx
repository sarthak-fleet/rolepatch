    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans">
            ...
            <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-800 min-h-[320px]">
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="space-y-2">
                  {[80, 70, 90, 65].map((w, i) => (
                    <div key={i} className="h-4 rounded bg-gray-200 dark:bg-gray-800" style={{ width: `${w}%` }} />
                  ))}
              ...
              <div className="p-6 space-y-3 bg-white dark:bg-gray-900">
                ...
                <div className="space-y-2">
                  {[
                    { w: 80, color: "bg-green-100 dark:bg-green-900/40" },
                    { w: 70, color: "bg-green-100 dark:bg-green-900/40" },
                    { w: 90, color: "bg-yellow-100 dark:bg-yellow-900/30" },
                    { w: 65, color: "bg-green-100 dark:bg-green-900/40" },
                  ].map((line, i) => (
                    <div key={i} className={`h-4 rounded ${line.color}`} style={{ width: `${line.w}%` }} />
                  ))}
                  <div className="mt-4 space-y-2">
                    {[85, 60, 75, 50].map((w, i) => (
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-3xl bg-green-600 dark:bg-green-700 p-12 shadow-2xl shadow-green-600/20 space-y-6">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          ...
          <div className="flex gap-6">
            <Link href="/dashboard" className="hover:text-gray-700 dark:hover:text-gray-200 transition-colors">App</Link>
